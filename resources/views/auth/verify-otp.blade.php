...
<div class="steam-auth-container">
    ...
    <div style="text-align: center;">
        <span class="email-badge">{{ request()->email }}</span>
    </div>
    ...
    <p style="color: #c7d5e0; text-align: center; margin-bottom: 20px;">Enter the 6-digit code sent to your email</p>

    <form method="POST" action="{{ route('forgot.password.otp.verify.post') }}">
        @csrf
        ...
        <button type="submit" class="steam-btn">Verify & Continue</button>
    </form>
</div>
@endsection
